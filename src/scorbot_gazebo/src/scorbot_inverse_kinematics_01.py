...
def inverse_kinematics (x, y, z):
    ...
    # theta2:
    #theta2 =  math.atan2 (z-d1, math.sqrt(x*x + y*y) -a1 -d5) - math.atan2 (a3*math.sin(theta3), a2 + a3*math.cos (theta3))
    term1 = z-d1
    term2 = math.sqrt(x*x + y*y) -a1 -d5
    term3 = a3*math.sin(theta3)
    term4 = a2 + a3*math.cos (theta3)
    term5 = math.atan2 (term1, term2)
    term6 = math.atan2 (term3, term4)
    theta2 = term5 - term6
...
if __name__ == '__main__':
    ...
    try:
        ...
        print (data0[2])
        print ()
        data0 = inverse_kinematics (data0[0],data0[1],data0[2])
        ...
        print (data1[2])
        print ()
        data1 = inverse_kinematics (data1[0],data1[1],data1[2])
